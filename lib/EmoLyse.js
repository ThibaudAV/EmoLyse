...
var EmoLyse = function(){
	...
	// nouvelle experience
	this.newExperience = function(nom, description, urlConfiguration, imageExp) {
		var configuration;
		...
		fs.copy(urlConfiguration+'/emotions', __dirname+"/../EXPERIENCES/"+_this.experience.ID+'/emotions', function(err){
			if (err) return false;
		});
